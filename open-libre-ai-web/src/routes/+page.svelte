...
<div class="py-16 sm:py-24">
	<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
	  <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
		...
		<p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">Please request mods for a beta account at the official <a href="https://discord.gg/v29eP5bZ">discord</a></p>
		...
		<form action="" method="GET" class="mx-auto mt-10 flex max-w-md gap-x-4">
			...
			<button type="submit" class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
				<a href="https://github.com/OpenLibreAI" target="_blank">Github</a>
			</button>
			<button type="submit" class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
				<a href="https://twitter.com/openlibreai" target="_blank">Twitter</a>
			</button>
			<button type="submit" class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
				<a href="https://discord.gg/v29eP5bZ" target="_blank">Discord</a>
			</button>
		</form>
